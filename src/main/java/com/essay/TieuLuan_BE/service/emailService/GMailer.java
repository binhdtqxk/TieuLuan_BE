...
public class GMailer {
    ...
    public GMailer() throws GeneralSecurityException, IOException {
        ...
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport,jsonFactory ))
                .setApplicationName("social media")
                .build();
    }
    private static final String EMAIL="phanthanhbinh2003@gmail.com";
    ...
    public void sendMail(String message, String to) throws Exception{
